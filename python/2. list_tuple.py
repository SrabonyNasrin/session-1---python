...
# List Operations
# Adding elements
print("Before Append Operation: ", simple_list)
...
#accessing elements
print("Third row , column one: ", two_D_list[2][0])

#modifying
two_D_list[2][0] = 22
print("Modified matrix: ", two_D_list)

#iterating
print("Iterating the 2D matrix")
for row in two_D_list:
    for each_elements in row:
        print(each_elements, end=" ")
    print()
...
multi_type_tuple = ("nasrin", 23, 5.2, False)
#print(multi_type_tuple)

multi_type_dictionary = {
    "string": multi_type_tuple[0],
    "integer": multi_type_tuple[1],
    "float": multi_type_tuple[2],
    "boolean": multi_type_tuple[3]
}
#tried
#print("Integer value: ", multi_type_tuple[0])
#Acessing & printing elements

print("string value is: ", multi_type_dictionary["string"])
print("integer value is: ", multi_type_dictionary["integer"])
print("float  value is: ", multi_type_dictionary["float"])
print("boolean value is: ", multi_type_dictionary["boolean"])

#updating dictionary
multi_type_dictionary["boolean"] = True
multi_type_dictionary["string"] = "SRABONY"

#printiing updating dictionary
print("updated Dictionary:", multi_type_dictionary["boolean"], " ",  multi_type_dictionary["string"] )
...
#sort by grades
sorted_list_tuples1 = sorted(student_grades, key=lambda x:x[1])
sorted_list_tuples2 = sorted(student_grades, key=lambda x:x[1], reverse=True)

#print(sorted_list_tuples1)
#print(sorted_list_tuples2)

#or
for student, grade in sorted_list_tuples1:
    print(f"{student}: {grade}")

print("-----------------")

#again in descending order
for student, grade in sorted_list_tuples2:
    print(f"{student}: {grade}")
