...
# Create a string containing bio data

simple_bio_data = "Name: Nasrin, Age: 23, Country: Bangladesh"

name = simple_bio_data[simple_bio_data.find("Name:") + len("Name:"): simple_bio_data.find(", Age:")]
age = simple_bio_data[simple_bio_data.find("Age:") + len("Age:"): simple_bio_data.find(", Country:")]
country = simple_bio_data[simple_bio_data.find("Country:") + len("Country:"):]
...
after_format = f"Here is Adele's information like Name: {person_info['NAME']}, Age: {person_info['AGE']}, occupation: {person_info['OCCUPATION']}"
print(after_format)
...
text = "Check out this #silly #odd library for #regex!"
