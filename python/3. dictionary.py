...
students = {
    "name": "Akter",
    "roll-number": 64,
    "grades": {"Mathematics": 95, "DBMS": 90, "AI/ML": 92}
}

print("Before editing: ", students)

#modifying name
students["name"] = "NASRIN"
students["grades"]["Mathematics"] = 98
...
#removing
removed_item = students.pop("name")
...
for students, grades in student_grades.items():
    ...
    print(f"{students}: {average_marks:.2f}")
